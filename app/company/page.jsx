    ...
    <>
      ...
      <section className="sec warm" style={{ padding:"clamp(40px,5vw,56px) 0" }}>
        <div className="wrap rv">
          <div className="card border-loop" style={{ "--card-bg":"var(--paper,#FAF8F4)", "--radius":"8px", padding:"clamp(20px,3vw,32px)", marginBottom:"clamp(24px,3.5vw,36px)" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"clamp(20px,3.5vw,48px)", alignItems:"start" }}>
            <div>
